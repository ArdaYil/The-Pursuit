...
public class Tile {
    ...
    public static class TileInitializer {
        ...
        public TileInitializer(Tile[] tiles) {
            ...
            this.tiles[5] = new Tile(getClass().getResourceAsStream("/tiles/BigHouse13.png"), true);
            this.tiles[6] = new Tile(getClass().getResourceAsStream("/tiles/BigHouse14.png"), true);
            this.tiles[7] = new Tile(getClass().getResourceAsStream("/tiles/BigHouse15.png"), true);
            this.tiles[8] = new Tile(getClass().getResourceAsStream("/tiles/BigHouse16.png"), true);
            ...
            this.tiles[17] = new Tile(getClass().getResourceAsStream("/tiles/BigTree1.png"), true);
            this.tiles[18] = new Tile(getClass().getResourceAsStream("/tiles/BigTree2.png"), true);
            this.tiles[19] = new Tile(getClass().getResourceAsStream("/tiles/BigTree3.png"), true);
            ...
            this.tiles[25] = new Tile(getClass().getResourceAsStream("/tiles/BigTree9.png"), true);
            ...
            this.tiles[37] = new Tile(getClass().getResourceAsStream("/tiles/House7.png"), true);
            this.tiles[38] = new Tile(getClass().getResourceAsStream("/tiles/House8.png"), true);
            this.tiles[39] = new Tile(getClass().getResourceAsStream("/tiles/House9.png"), true);
